...
>
  ...
  <div id="carousel-wrapper" class="absolute inset-0 flex transition-transform duration-700 ease-in-out">
    ...
    <div class="w-full flex-shrink-0 bg-cover bg-center"
         style="background-image: url('{{ asset('images/HOME/SECTION 5/inside news/1.jpg') }}');">
    </div>

    <!-- Slide 2 -->
    <div class="w-full flex-shrink-0 bg-cover bg-center"
         style="background-image: url('{{ asset('images/HOME/SECTION 5/inside news/2.jpg') }}');">
    </div>

    <!-- Slide 3 -->
    <div class="w-full flex-shrink-0 bg-cover bg-center"
         style="background-image: url('{{ asset('images/HOME/SECTION 5/inside news/3.jpg') }}');">
    </div>
      ...
      <!-- Slide 4 -->
    <div class="w-full flex-shrink-0 bg-cover bg-center"
         style="background-image: url('{{ asset('images/HOME/SECTION 5/inside news/4.jpg') }}');">
    </div>
  </div>
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const observer = new IntersectionObserver(
      ...
      },
      {
        ...
        rootMargin: "0px 0px -20% 0px", // start slightly before full visibility
      }
    );
