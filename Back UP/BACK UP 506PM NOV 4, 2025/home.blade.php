...
<section id="features" class="w-full py-16 bg-gray-100 flex flex-col items-center">
  <div
    class="grid grid-cols-2 sm:grid-cols-5 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8 max-w-7xl px-4 sm:px-8 lg:px-12 transition-transform duration-300"
  >
    <!-- Card 1 -->
    <a
      href="#living"
      class="relative group h-48 sm:h-64 lg:h-72 w-full rounded-xl overflow-hidden shadow-lg transform hover:scale-105 transition-all duration-300"
    >
      <img
        src="{{ asset('images/HOME/SECTION 3/1.jpg') }}"
        alt="Living Room"
    ...
    >
      <img
        src="{{ asset('images/HOME/SECTION 3/2.jpg') }}"
        alt="Kitchen"
        class="absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity duration-300"
      />
      <div
    ...
    >
      <img
        src="{{ asset('images/HOME/SECTION 3/3.jpg') }}"
        alt="Bedroom"
        class="absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity duration-300"
      />
      <div
    ...
    >
      <img
        src="{{ asset('images/HOME/SECTION 3/4.jpg') }}"
        alt="Bedroom"
        class="absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity duration-300"
      />
      <div
    ...
    >
      <img
        src="{{ asset('images/HOME/SECTION 3/5.jpg') }}"
        alt="Bedroom"
        class="absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity duration-300"
      />
      <div
...
<section 
  id="carousel-section"
  class="relative mt-10 w-full min-h-[400vh] sm:min-h-[80vh] lg:min-h-screen overflow-hidden flex items-center justify-center bg-gray-900 fade-section opacity-0 translate-y-5 transition-all duration-700"
>
  <!-- Slider Wrapper -->
  <div id="carousel-wrapper" class="relative flex w-full h-full transition-transform duration-700 ease-in-out">
    <!-- Slide 1 -->
    <div class="w-full flex-shrink-0">
      <img 
        src="{{ asset('images/HOME/SECTION 4/1.jpg') }}" 
        alt="Slide 1"
    ...
    <div class="w-full flex-shrink-0">
      <img 
        src="{{ asset('images/HOME/SECTION 4/2.jpg') }}" 
        alt="Slide 2"
        class="w-full h-full object-cover object-center"
      />
    </div>
    ...
    <div class="w-full flex-shrink-0">
      <img 
        src="{{ asset('images/HOME/SECTION 4/3.jpg') }}" 
        alt="Slide 3"
        class="w-full h-full object-cover object-center"
      />
    </div>
    ...
    <div class="w-full flex-shrink-0">
      <img 
        src="{{ asset('images/HOME/SECTION 4/4.jpg') }}" 
        alt="Slide 4"
        class="w-full h-full object-cover object-center"
      />
    </div>
  ...
  <!-- 🔥 Overlay -->
  <div class="absolute inset-0 bg-black/50 md:bg-black/30 z-[1]"></div>

  <!-- Info Box -->
  <div class="absolute inset-0 flex flex-col items-center justify-center text-white z-[2] px-4 sm:px-8">
    <div class="bg-black/60 sm:bg-transparent backdrop-blur-sm sm:backdrop-blur-none p-4 sm:p-6 rounded-xl shadow-lg text-center max-w-[90%] sm:max-w-md">
      <h2 id="carousel-title" class="text-2xl sm:text-4xl lg:text-5xl font-bold mb-2 sm:mb-4 leading-snug sm:leading-tight">
  ...
  <button 
    id="prev"
    class="absolute left-4 sm:left-8 top-1/2 -translate-y-1/2 bg-white/70 hover:bg-white text-gray-700 p-2 sm:p-3 rounded-full shadow-md transition z-[3]"
  >
    ❮
  </button>
  ...
  <button 
    id="next"
    class="absolute right-4 sm:right-8 top-1/2 -translate-y-1/2 bg-white/70 hover:bg-white text-gray-700 p-2 sm:p-3 rounded-full shadow-md transition z-[3]"
  >
    ❯
  </button>
</section>
