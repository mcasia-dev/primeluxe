        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div data-aos="fade-right">
                ...
                <div class="space-y-6 text-lg text-gray-700 leading-relaxed text-justify">
                    @if(!is_null($material->description))
                        <div class="text-gray-700 prose">{!! $material->description !!}</div>
                    @else
                        <p class="text-gray-700">
                            Every Primeluxe interior is defined by the materials that compose it. We work with a
                            carefully
                            curated palette of surfaces and components selected for their beauty, performance, and
                            longevity.
                        </p>
                    @endif
                    <div class="pt-3">
                        <a href="#materials"
                           class="inline-flex items-center gap-2 px-5 py-2.5 border border-yellow-500 text-yellow-700 hover:text-yellow-800 hover:border-yellow-600 rounded-lg transition-all duration-300 hover:bg-yellow-50">
                            {{ $material->button_label ?? 'Explore More' }}
            ...
            <div data-aos="fade-left">
                <div class="relative">
                    ...
                    <div
                        ...
                        <img
                            src="{{ filled($material->getFirstMediaUrl('material-image')) ? $material->getFirstMediaUrl('material-image') : asset('images/materials/banner.jpg') }}"
