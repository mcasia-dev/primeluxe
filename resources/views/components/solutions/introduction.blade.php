        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div data-aos="fade-right">
                <h2 class="text-4xl sm:text-5xl font-light text-gray-900 mb-7 leading-tight">
                    {{ $solution->subtitle ?? 'Spaces Curated For You' }}
                </h2>
                <div class="space-y-6 text-lg text-gray-700 leading-relaxed text-justify">
                    @if(!is_null($solution->description))
                        <div class="text-gray-700 prose">{!! $solution->description !!}</div>
                    @else
                        <p class="text-gray-700">
                            Primeluxe creates integrated interior environments for modern luxury homes. From kitchens
                            and
                        ...
                        <p class="text-gray-700">
                            Each space is tailored to the rhythms of daily life, engineered for longevity, and crafted
                            to
                            elevate the experience of living well.
                        </p>
                    @endif
                    <div class="pt-3">
                        <a href="#solutions"
                           class="inline-flex items-center gap-2 px-5 py-2.5 border border-yellow-500 text-yellow-700 hover:text-yellow-800 hover:border-yellow-600 rounded-lg transition-all duration-300 hover:bg-yellow-50">
                            {{ $solution->button_label ?? 'Explore More' }}
            ...
            <div data-aos="fade-left">
                <div class="relative">
                    ...
                    <div
                        ...
                        <img src="{{ filled($solution->getFirstMediaUrl('solution-image')) ? $solution->getFirstMediaUrl('solution-image') : asset('images/solutions/banner.jpg') }}" alt="Premium Interior Solutions"
