...
<div class="mb-20 overflow-hidden rounded-xl shadow-lg bg-white" data-aos="fade-up" data-aos-delay="{{ $delay }}">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
        <!-- Image -->
        <div class="relative h-80 lg:h-auto overflow-hidden bg-gray-200 {{ $imagePosition === 'left' ? 'order-2 lg:order-1' : 'order-2 lg:order-2' }}">
        ...
        <div class="p-8 sm:p-12 lg:p-16 flex flex-col justify-center {{ $imagePosition === 'left' ? 'order-1 lg:order-2' : 'order-1 lg:order-1' }}">
            ...
            <p class="text-lg text-yellow-600 font-semibold mb-4">{{ $tagline }}</p>
            <p class="text-gray-700 mb-6 leading-relaxed">{{ $description }}</p>
            <div class="space-y-2">
                <h4 class="font-semibold text-gray-900 mb-3">Includes:</h4>
