<style>
    ...
    .solutions-hero-visual {
        animation: solutionsHeroZoom 14s ease-in-out infinite alternate;
    }
</style>

<section class="relative w-full min-h-[60vh] sm:min-h-[65vh] flex items-center justify-center overflow-hidden">
    <div class="solutions-hero-visual absolute inset-0 bg-cover bg-center"
        style="background-image: url('{{ filled($solution->getFirstMediaUrl('solution-banner')) ? $solution->getFirstMediaUrl('solution-banner') : asset('images/HOME/SECTION 3/1.jpg') }}');"></div>
