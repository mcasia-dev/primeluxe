<section class="w-full bg-white py-20 sm:py-24 lg:py-28">
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-14 sm:mb-16" data-aos="fade-up">
            <h2 class="text-4xl sm:text-5xl font-light text-gray-900 mb-4">Why Choose Primeluxe</h2>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div class="fade-on-scroll opacity-0 translate-y-10 transition-all duration-1000 ease-out p-8 rounded-2xl border border-black/10 bg-white shadow-[0_14px_34px_rgba(20,20,20,0.08)] hover:shadow-[0_20px_42px_rgba(20,20,20,0.12)] transition-all">
