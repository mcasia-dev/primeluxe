<section class="w-full bg-gradient-to-b from-gray-50 to-white py-20">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 gap-12">
            <!-- Mission Card -->
            <div
                class="fade-on-scroll opacity-0 translate-y-10 transition-all duration-1000 ease-out bg-white rounded-xl shadow-lg p-10 border-l-4 border-yellow-500">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-gray-900">Mission</h3>
                </div>
            ...
            <!-- Vision Card -->
            <div class="fade-on-scroll opacity-0 translate-y-10 transition-all duration-1000 ease-out bg-white rounded-xl shadow-lg p-10 border-l-4 border-yellow-500"
                ...
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-gray-900">Vision</h3>
                </div>
                <h5 class="text-base md:text-lg font-bold text-gray-900 mb-3">Shaping the Future of Minimalist Living
                </h5>
