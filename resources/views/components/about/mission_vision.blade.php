<section class="w-full bg-gradient-to-b from-gray-50 via-white to-gray-50 py-20 sm:py-24 lg:py-28">
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-14 sm:mb-16" data-aos="fade-up">
            <h2 class="text-4xl sm:text-5xl font-light text-gray-900 mb-4">Our Mission & Vision</h2>
        </div>
