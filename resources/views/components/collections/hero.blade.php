<style>
    ...
    .collections-hero-visual {
        animation: collectionsHeroZoom 14s ease-in-out infinite alternate;
    }
</style>

<section class="relative w-full min-h-[60vh] sm:min-h-[65vh] flex items-center justify-center overflow-hidden">
    <div class="collections-hero-visual absolute inset-0 bg-cover bg-center"
        style="background-image: url('{{ asset('images/HOME/SECTION 3/4.jpg') }}');"></div>
