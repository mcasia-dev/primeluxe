<style>
    ...
    .systems-hero-visual {
        animation: systemsHeroZoom 14s ease-in-out infinite alternate;
    }
</style>

<section class="relative w-full min-h-[60vh] sm:min-h-[65vh] flex items-center justify-center overflow-hidden">
    <div class="systems-hero-visual absolute inset-0 bg-cover bg-center"
